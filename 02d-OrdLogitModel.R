...
save(file="RDataFiles/OrdLogitModel.RData", best_polr_model_and_metrics = union_select80_2c_polr_model, final_selected_ord_vars = best_features, PolrFitter, PolrPredictor)
